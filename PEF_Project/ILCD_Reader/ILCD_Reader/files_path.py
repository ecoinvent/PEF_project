...
INDEXES_PEF_ALLOCATION = os.path.join(BASE_DIR, "Data", "input", "pickles", "updated_pickles", "indexes.xlsx")
...
MATRIX_A_PICKLE = os.path.join(BASE_DIR, "Data", "input", "pickles", "updated_pickles", "A.pkl")
...
PICKLES_SOURCE_DIRECTORY = os.path.join(BASE_DIR, "Data", "input", "pickles", "updated_pickles")
...
PICKLE_DESTINATION_DIRECTORY = os.path.join(BASE_DIR, "Data", "output", "pickles", "updated")
